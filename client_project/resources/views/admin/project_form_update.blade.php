        ...
        <div class="px-1 bg-slate-300 mx-auto w-fit py-1 h-fit mt-4 rounded-lg shadow-lg mb-10 dark:bg-[#161A1D]">
            <div class="bg-white w-[500px] border-[1.5px] border-slate-300 rounded-2xl dark:bg-[#22272B] dark:border-[#161A1D]">
                <div class="px-6 py-4 border-b-[1.5px] border-slate-300 flex justify-between items-center dark:border-[#38414A]">
                    <div>
                        <p class="text-xl font-semibold text-slate-800 dark:text-white">Update Project Form</p>
                        <p class="text-sm text-slate-500 font-medium dark:text-gray-400">Update project detail</p>
                    </div>
                    <div class="">
                ...
                <div class="px-6 py-4">
                    <form action="{{route('project.update.store', $data->project_id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                            <p class="text-slate-700 font-medium dark:text-gray-200">Project Name </p>
                            <input type="text" name="project_name" value="{{$data->project_name}}" placeholder="Project name..." class="border-[1.5px] border-slate-300 w-full py-1 px-2 mt-2 rounded-md outline-none text-slate-700 focus:ring-1 focus:border-blue-100 transition-all duration-150 dark:bg-[#22272B] dark:border-[#38414A] dark:text-gray-300 dark:focus:border-blue-300">
                        </div>
                        <div class="flex">
                            <div class="mt-3 w-full">
                                <p class="text-slate-700 font-medium dark:text-gray-200">Category</p>
                                <select name="category"  class="border-[1.5px] mt-2 py-1 px-2 rounded-md text-slate-700 border-slate-300 w-full outline-none focus:ring-1 focus:border-blue-100 transition-all duration-150 dark:bg-[#22272B] dark:border-[#38414A] dark:text-gray-300 dark:focus:border-blue-300">
                                    <option value="" disabled selected>Old: {{$data->category}}</option>
                        ...
                        <div class="mt-3 w-full">
                            ...
                            <textarea name="description" cols="30" rows="10" class="border-[1.5px] w-full px-2 py-2 border-slate-300 rounded-md outline-none text-slate-700 h-32 focus:ring-1 focus:border-blue-100 transition-all duration-150 dark:bg-[#22272B] dark:border-[#38414A] dark:text-gray-300 dark:focus:border-blue-300" placeholder="Insert description here..."></textarea>
                        </div>
                        <div class="mt-3 grid grid-cols-2 gap-4">
                            <div class="">
                                <p class="text-slate-700 font-medium dark:text-gray-200">Project Started</p>
                                <input type="date" name="start" value="{{$data->start}}" class="border-[1.5px] py-1 rounded-md mt-2 px-2 w-full border-slate-300 text-slate-700 focus:ring-1 focus:border-blue-100 transition-all duration-150 outline-none dark:bg-[#22272B] dark:border-[#38414A] dark:text-gray-300 dark:focus:border-blue-300">
                            </div>
                            <div class="">
                                <p class="text-slate-700 font-medium dark:text-gray-200">Project Ended</p>
                                <input type="date" name="due_contract" value="{{$data->due_contract}}" class="border-[1.5px] py-1 rounded-md mt-2 px-2 w-full border-slate-300 text-slate-700 focus:ring-1 focus:border-blue-100 transition-all duration-150 outline-none dark:bg-[#22272B] dark:border-[#38414A] dark:text-gray-300 dark:focus:border-blue-300">
                            </div>
                        </div>
                        <p class="mt-4 mb-3 text-slate-700 font-medium dark:text-gray-200">Project Tumbnail</p>
                        ...
                        {{-- <input type="file" name="tumbnail" class="mt-3"> --}}
