            ...
            <div class="flex flex-wrap md:px-8 px-4 relative justify-between w-full">
                    ...
                    <div @click.away="open = false" class="absolute w-full right-0 left-0 mt-4 bg-white dark:bg-[#1D2125] rounded" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform -translate-y-1" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-0">
                        <div class="bg-white w-full rounded-b-lg pb-2 dark:bg-[#1D2125]">
                            @if (Auth::user()->role === 'admin')
                                ...
                                <div class="w-full">
                                    <a href="{{route('chat.index')}}" class="flex w-full hover:bg-slate-200 dark:hover:bg-[#161A1D] py-2 px-5 {{request()->is('chat*') ? 'text-blue-500 dark:bg-[#161A1D] bg-slate-200' : 'text-slate-600 dark:text-slate-200'}}">
                            ...
                            <div class="w-full">
                                <button id="toggleDarkMode" class="mr-4 my-auto w-full hover:bg-slate-300 dark:hover:bg-[#161A1D] py-2 px-5">
                                    <div id="moonIcon" class="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg"  width="18"  height="18"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-moon text-slate-500 transition duration-500 my-auto"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
                                        <p class="my-auto ml-2 text-slate-600 dark:text-slate-200">Darkmode</p>
                                    </div>
                                    <div id="sunIcon" class="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg"  width="18"  height="18"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-sun text-slate-500 dark:text-white my-auto"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" /></svg>
                ...
                <div class="flex flex-wrap py-2 md:py-0">
                    <div class="flex">
                        ...
                        <div class="md:flex my-auto ml-8 py-3 hidden">
                            @if (Auth::user()->role === 'admin')
                ...
                <div class="flex my-auto">
                    <button id="toggleDarkMode2" class="mr-4 my-auto hidden md:flex">
                    ...
                    @if (Auth::user()->role == 'user')
                        <a href="{{route('notifications')}}" class="my-auto hidden md:flex">
                            <div class="relative">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-bell {{request()->is('notifications*') ? 'text-blue-500' : 'text-slate-600 dark:text-slate-200'}}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 5a2 2 0 1 1 4 0a7 7 0 0 1 4 6v3a4 4 0 0 0 2 3h-16a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6" /><path d="M9 17v1a3 3 0 0 0 6 0v-1" /></svg>
                                @if ($unread>0)
                                    <div class="w-2 h-2 rounded-full bg-red-500 absolute left-3 bottom-3 items-center justify-center {{request()->is('notifications*') ? 'hidden' : 'block'}}"></div>
                                @endif
                            </div>
                        </a>
                    @endif
