...
class="w-full overflow-hidden">
    ...
    {{-- header --}}
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b dark:bg-[#161A1D]" >
        <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
            ...
            <h6 class="font-bold truncate dark:text-gray-100"> {{$selectedConversation->getReceiver()->name}} </h6>
        </div>
    </header>
    {{-- body --}}
    <main 
    ...
    id="conversation"  class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class([
            ...
            <div @class(['flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]',
                         'rounded-bl-none border dark:bg-[#22272B] dark:text-white dark:border-[#2C333A]  border-gray-200/40 '=>!($message->sender_id=== auth()->id()),
            ...
            <div class="ml-auto flex gap-2">
                <p @class([
                    'text-xs ',
                    'text-gray-500 dark:text-gray-300'=>!($message->sender_id=== auth()->id()),
    ...
    {{-- send message  --}}
    <footer class="shrink-0 z-10 bg-white inset-x-0 dark:bg-[#161A1D]">
        <div class=" p-2 border-t dark:border-[#454F59]">
            <form
             ...
             method="POST" autocapitalize="off">
                ...
                <div class="grid grid-cols-12">
                     <input 
                            ...
                            maxlength="1700"
                            class="col-span-10 bg-gray-100 dark:bg-[#22272B] dark:text-gray-200 border-0 outline-0 focus:border-0 focus:ring-0 hover:ring-0 rounded-lg  focus:outline-none p-2"
                     >
                     <button x-bind:disabled="!body.trim()"  class="col-span-2 dark:text-white" type='submit'>Send</button>
                </div>
            </form>
            {{-- @error('body')
            <p> {{$message}} </p>
