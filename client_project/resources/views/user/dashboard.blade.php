...
<div class="container">
    <div class="md:px-12 px-5">
        ...
        <div class="grid md:grid-cols-4 grid-cols-1 gap-2 md:gap-4 pt-4">
            <a href="{{route('user.project')}}" class="group md:hover:shadow-md active:shadow-md">
            ...
            <a href="{{route('user.project', ['category' => 'Complete'])}}" class="group md:hover:shadow-md active:shadow-md">
                <div class="w-full shadow rounded flex">
            ...
            <a href="{{route('user.invoice', ['time_period' => 'every_time', 'status' => 'pending'])}}" class="group md:hover:shadow-md active:shadow-md">
                <div class="w-full shadow rounded flex">
                    <span class="px-1 bg-red-500 rounded-l md:group-hover:bg-red-800 group-active:bg-red-800"></span>
                    <div class="px-4 py-4 bg-white dark:bg-[#1D2125] w-full rounded-r flex">
                        <div class="w-3/4 my-auto">
                            <p class="text-gray-500 font-medium uppercase text-sm dark:text-gray-400">NOT PAID</p>
                            <p class="text-gray-700 font-medium text-xl dark:text-gray-300">Rp. {{number_format($notPaid)}}</p>
                        </div>
                        <div class="my-auto w-1/4">
                            <div class="bg-red-500 group-hover:bg-red-800 rounded-full p-3 w-fit float-right hidden md:block">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="34"  height="34"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-cash-off dark:text-[#1D2125]  text-white">
                            ...
                            <div class="bg-red-500 group-active:bg-red-800 rounded-full p-3 w-fit float-right md:hidden">
            ...
            <a href="{{route('user.invoice', ['time_period' => 'every_time', 'status' => 'paid'])}}" class="group md:hover:shadow-md active:shadow-md">
                <div class="w-full shadow rounded flex">
                    <span class="px-1 bg-violet-500 rounded-l md:group-hover:bg-violet-800 group-active:bg-violet-800"></span>
                    <div class="px-4 py-4 bg-white w-full rounded-r flex dark:bg-[#1D2125]">
                        <div class="w-3/4 my-auto">
                            <p class="text-gray-500 font-medium uppercase text-sm dark:text-gray-400">Total Expends</p>
                            <p class="text-gray-700 font-medium dark:text-gray-300">Rp. {{number_format($amount)}}</p>
                        </div>
                        <div class="my-auto w-1/4">
                            <div class="bg-violet-500 rounded-full group-hover:bg-violet-800 p-3 w-fit float-right hidden md:block">
                    ...
                    <table class="md:w-full w-[900px] mt-4">
                        <thead class="text-left">
                            <tr>
                                ...
                                <th class="py-1 font-medium text-gray-700 bg-gray-200 px-4 dark:bg-[#161A1D] dark:text-gray-300">Project</th>
